  ...
  <!-- start: Navigation -->
	<nav id="nav">
      ...
      <li style="animation-delay: 0.0s; margin-bottom: 4rem;" class="animated bounceInLeft slow"><a <?php if($title == "Covid-19") echo 'id="active"'; ?> href="<?php echo site_url('covid_19'); ?>">Covid-19</a></li>
			<li style="animation-delay: 0.2s;" class="animated bounceInLeft slow"><a <?php if($title == "Booking") echo 'id="active"'; ?> href="/booking">Booking</a></li>
      <li style="animation-delay: 0.4s;" class="animated bounceInLeft slow"><a <?php if($title == "Location") echo 'id="active"'; ?> href="/location">Location</a></li>
      <li style="animation-delay: 0.6s;" class="animated bounceInLeft slow"><a <?php if($title == "Gallery") echo 'id="active"'; ?> href="/gallery">Gallery</a></li>
      <li style="animation-delay: 0.8s;" class="animated bounceInLeft slow"><a <?php if($title == "Info") echo 'id="active"'; ?> href="/info">Info</a></li>
      <li style="animation-delay: 1.0s;" class="animated bounceInLeft slow"><a <?php if($title == "Contact") echo 'id="active"'; ?> href="/contact">Contact</a></li>
		</ul>
	</nav>
  <!-- end: Navigation -->
  ...
  <main id="main_absolute" class="animated fadeIn slow">
    <div class="row" style="margin-bottom: 4rem; clear: both;">
      <div style="border-bottom: grey 5px solid;" class="booking_blocks_of_3 block_full">
        <a style="color: black; font-size: 1.5em" href="/booking">There was an error completing your booking request</a>
      </div>
    </div>

    <div class="row" style="margin-bottom: 5rem; clear: both; text-align: center">
      <br>
      <p style="color: grey">Please try again!</p>
      <br><br>
