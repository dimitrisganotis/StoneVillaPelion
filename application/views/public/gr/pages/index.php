...
<body id="homepage_body">
  ...
  <nav id="nav" style="background: none">
    <ul>
      ...
      <li style="animation-delay: 0.1s;" class="animated bounceInLeft slow"><a <?php if($title == "Κράτηση") echo 'id="active"'; ?> href="<?php echo site_url('gr/booking'); ?>">Κράτηση</a></li>
      ...
      <li style="animation-delay: 0.3s;" class="animated bounceInLeft slow"><a <?php if($title == "Φωτογραφίες") echo 'id="active"'; ?> href="<?php echo site_url('gr/gallery'); ?>">Φωτογραφίες</a></li>
      <li style="animation-delay: 0.4s;" class="animated bounceInLeft slow"><a <?php if($title == "Πληροφορίες") echo 'id="active"'; ?> href="<?php echo site_url('gr/info'); ?>">Πληροφορίες</a></li>
      <li style="animation-delay: 0.5s;" class="animated bounceInLeft slow"><a <?php if($title == "Επικοινωνία") echo 'id="active"'; ?> href="<?php echo site_url('gr/contact'); ?>">Επικοινωνία</a></li>
    </ul>
  </nav>
  <!-- end: Navigation -->
